...
public abstract class SimpleGUI {
	...
	public static HashMap<Player, SimpleGUI> openInventories = new HashMap<Player, SimpleGUI>();
	public static HashMap<Player, SimpleGUI> openInventoriesDelayed = new HashMap<Player, SimpleGUI>();
	...
	public void close(boolean silent){
		for(Entry<Player, SimpleGUI> e:openInventories.entrySet()){
